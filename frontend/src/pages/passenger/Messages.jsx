...
const conversations = [
  {
    ...
    unread: 1,
    messages: [
      { from: 'them', text: 'Hello! I have accepted your ride request.', time: '14:28' },
      { from: 'me', text: 'Great! I am at the main entrance.', time: '14:29' },
      { from: 'them', text: 'I am 2 minutes away from your location.', time: '14:31' },
    ]
  },
  {
    id: 2,
    name: 'Support Team',
    avatar: '🛡️',
    lastMessage: 'Your issue has been resolved. Thank you!',
    time: '1 day ago',
    unread: 0,
    messages: [
      { from: 'me', text: 'I had an issue with my last payment.', time: '09:10' },
      { from: 'them', text: 'Thank you for contacting support. We are looking into it.', time: '09:15' },
      { from: 'them', text: 'Your issue has been resolved. Thank you!', time: '10:00' },
    ]
  },
  {
    id: 3,
    name: 'George P. (Driver)',
    avatar: '🚗',
    lastMessage: 'Safe travels! Please rate your experience.',
    time: '3 days ago',
    unread: 0,
    messages: [
      { from: 'them', text: 'On my way to pick you up!', time: '18:44' },
      { from: 'me', text: 'Thanks, I can see you on the map.', time: '18:45' },
      { from: 'them', text: 'Safe travels! Please rate your experience.', time: '19:10' },
    ]
  },
]
...
export default function PassengerMessages() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <PageHeader title="Messages" subtitle="Chat with drivers and support" />
            ...
            {msgs.map((msg, i) => (
              <div key={i} className={`flex ${msg.from === 'me' ? 'justify-end' : 'justify-start'}`}>
                <div className="max-w-xs px-4 py-2 rounded-2xl text-sm" style={{
                  ...
                  color: msg.from === 'me' ? 'white' : '#e5e7eb',
